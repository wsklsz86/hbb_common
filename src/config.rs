...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Qwe123..".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["112.250.108.132"];
pub const RS_PUB_KEY: &str = "DuMvpglVS+1recId0K84gllQqeNyWbmJvgVq49f7Xvw=";
